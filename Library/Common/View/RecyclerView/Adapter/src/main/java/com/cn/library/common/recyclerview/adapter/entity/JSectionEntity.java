package com.cn.library.common.recyclerview.adapter.entity;

import com.cn.library.common.recyclerview.adapter.entity.SectionEntity; /**
 * 仅供java使用
 *
...
public abstract class JSectionEntity implements SectionEntity {
    ...
    public int getItemType() {
        if (isHeader()) {
            return Companion.HEADER_TYPE;
        } else {
            // 拷贝 重写此处，返回自己的多布局类型
            return Companion.NORMAL_TYPE;
        }
    }
}
