...
import com.cn.library.common.recyclerview.adapter.dragswipe.DragAndSwipeCallback
import com.cn.library.common.recyclerview.adapter.holder.BaseViewHolder
import com.cn.library.common.recyclerview.adapter.listener.DraggableListenerImp
import com.cn.library.common.recyclerview.adapter.listener.OnItemDragListener
import com.cn.library.common.recyclerview.adapter.listener.OnItemSwipeListener
import java.util.*
...
open class BaseDraggableModule(private val baseQuickAdapter: BaseQuickAdapter<*, *>) :
    ...
    open fun onItemDragMovePos(viewHolder:RecyclerView.ViewHolder,dX:Float, dY:Float, actionState:Int, isCurrentlyActive:Boolean){
