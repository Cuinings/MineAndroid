/*
package com.cn.sample.test.child.wallpaper.viewmodel
...
sealed class WallpaperEvent: UiIntent {
    data class WallpaperUpdate(val context: Context): WallpaperEvent()
}
@HiltViewModel
class WallpaperViewModel @Inject constructor(): BasicMviViewModel<WallpaperState, WallpaperEvent>() {
