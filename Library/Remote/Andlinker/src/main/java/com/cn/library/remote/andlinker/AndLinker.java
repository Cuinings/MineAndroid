...
import static com.cn.library.remote.andlinker.Utils.checkNotNull;
...
import com.cn.library.remote.andlinker.adapter.DefaultCallAdapterFactory;
...
//            mBindCallback.onUnBind();
    ...
    private ICallback createCallback() {
        return new ICallback.Stub() {
            @Override
            public Response callback(Request request) {
