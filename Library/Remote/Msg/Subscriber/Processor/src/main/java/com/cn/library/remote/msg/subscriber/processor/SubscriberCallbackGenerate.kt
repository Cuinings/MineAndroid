...
import com.cn.library.remote.msg.subscriber.processor.FilerExt.generate
...
object SubscriberCallbackGenerate {
    ...
    fun Filer.generateSubscriberCallback(println: (String) -> Unit) {
        TypeSpec.classBuilder("SubscriberCallback").addModifiers(Modifier.PUBLIC)
            .addSuperinterface(ClassName.get("com.cn.library.remote.msg.router.client.callback", "MsgCallback"))
            .addField(
                FieldSpec.builder(
                ...
                MethodSpec.constructorBuilder().addModifiers(Modifier.PUBLIC).addJavadoc("构造函数")
                    .addStatement("com.cn.library.remote.msg.router.client.MsgRouter.INSTANCE.bind(this)")
                    .apply {
                ...
                MethodSpec.methodBuilder("onRcvMsg").addAnnotation(Override::class.java)
                    .addModifiers(Modifier.PUBLIC).addParameter(
                        ParameterSpec.builder(ClassName.get("com.cn.library.remote.msg.router.client.bean", "Msg"), "msg",).build()
                    ).addParameter(
