...
public final class Logger {
    ...
    private final static LogAdapter DEFAULT_LOG_ADAPTER = (priority, tag, msg) -> Log.println(priority, tag, msg);

    static boolean sEnable = false;

    private static LogAdapter logAdapter = DEFAULT_LOG_ADAPTER;
    ...
    private static void log(int priority, String tag,  String msg, Throwable t) {
        ...
        if(logAdapter!=null) logAdapter.println(priority, curTag, curMsg);
