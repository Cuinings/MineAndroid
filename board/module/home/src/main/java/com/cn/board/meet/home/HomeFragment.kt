...
//
//class HomeFragment : BasicVmVBFragment<AppListViewModel, FragmentAppListBinding>(
...
//        activity?.let { binding.container.showGlassBlurViews(it) }?: Log.e(HomeFragment::class.simpleName, "no activity")
//    }
//
